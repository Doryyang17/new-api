...
func SetRelayRouter(router *gin.Engine) {
	...
	relayV1Router.Use(middleware.SystemAvailabilityCheck())
	...
	relayV1Router.Use(middleware.ModelRequestRateLimit())
	{
		...
		wsRouter.Use(middleware.PromptComplianceCheck(""))
	...
	}
	{
		...
		httpRouter.Use(middleware.PromptComplianceCheck(""))
	...
	relayMjRouter.Use(middleware.SystemAvailabilityCheck())
	relayMjRouter.Use(middleware.SystemDailyUsageLimitCheck())
	relayMjRouter.Use(middleware.SystemPerformanceCheck())
	registerMjRouterGroup(relayMjRouter)

	relayMjModeRouter := router.Group("/:mode/mj")
	relayMjModeRouter.Use(middleware.RouteTag("relay"))
	relayMjModeRouter.Use(middleware.SystemAvailabilityCheck())
	relayMjModeRouter.Use(middleware.SystemDailyUsageLimitCheck())
	...
	relayGeminiRouter.Use(middleware.SystemAvailabilityCheck())
