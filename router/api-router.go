...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.POST("/oauth/:provider/complete-registration", middleware.CriticalRateLimit(), anonymousRequestBodyLimit, middleware.RegistrationCodeRiskCheck(), middleware.TurnstileCheckStrict(), controller.CompleteOAuthRegistration)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.POST("/register", middleware.CriticalRateLimit(), middleware.DisableCache(), anonymousRequestBodyLimit, middleware.RegistrationCodeRiskCheck(), middleware.TurnstileCheckStrict(), controller.Register)
			userRoute.POST("/login", middleware.CriticalRateLimit(), middleware.DisableCache(), anonymousRequestBodyLimit, middleware.TurnstileCheckStrict(), controller.Login)
		...
		registrationCodeRoute.Use(middleware.RootAuth())
		{
			...
			registrationCodeRoute.POST("/batch", controller.CreateRegistrationCodes)
		}
		...
		logRoute.GET("/detail", middleware.DisableCache(), middleware.AdminAuth(), controller.GetAllLogDetail)
		logRoute.GET("/self/stat", middleware.UserAuth(), controller.GetLogsSelfStat)
		logRoute.GET("/self/detail", middleware.DisableCache(), middleware.UserAuth(), controller.GetUserLogDetail)
