...
func preConsumeUserSubscriptionTx(tx *gorm.DB, requestId string, userId int, modelName string, quotaType int, amount int64, now int64) (*SubscriptionPreConsumeResult, error) {
	if tx == nil {
