...
func InitOptionMap() {
	...
	common.OptionMap["RegistrationCodeRegisterEnabled"] = strconv.FormatBool(common.RegistrationCodeRegisterEnabled)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" || key == "SMTPInsecureSkipVerify" {
		...
		case "RegistrationCodeRegisterEnabled":
			common.RegistrationCodeRegisterEnabled = boolValue
