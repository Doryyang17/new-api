...
func (b *taskSubmissionTestBilling) Refund(*gin.Context) error {
...
func TestImmediateTaskSettlementDatabase(t *testing.T) {
	...
	models := []any{&model.User{}, &model.Channel{}, &model.Task{}, &model.Log{}, &model.CheckinBonus{}, &model.CheckinBonusUsage{}}
...
`
	...
	for index, tc := range []struct {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			info.RequestId = info.PublicTaskID
