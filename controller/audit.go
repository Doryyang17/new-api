...
var auditContentTemplates = map[string]string{
	...
	"user.quota_grant":       "Received an administrator quota grant of $${amount_usd}: ${reason}",
	"user.quota_grant_batch": "Granted $${amount_usd} to ${count} users: ${reason}",
	...
	"registration_code.create":     "Created ${count} registration codes",
