...
func main() {
	...
	service.StartSystemDailyUsageUpdater()
	...
	server := gin.New()
	if err := configureTrustedProxyPolicy(server); err != nil {
		common.FatalLog("failed to configure trusted proxy policy: " + err.Error())
		return
	}
